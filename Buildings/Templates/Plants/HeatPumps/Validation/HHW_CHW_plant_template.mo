...
model HHW_CHW_plant_template "Validation of AWHP plant template"
...
public
  FourPipeASHP_with_controls_templatemodel
    fourPipeASHP_with_controls_templatemodel(
    m1_flow_nominal=fourPipeASHP_with_controls_templatemodel.mChiWatPri_flow_nominal,
    m2_flow_nominal=fourPipeASHP_with_controls_templatemodel.mHeaWatPri_flow_nominal,
    datAll=datAll,
    QHea_flow_nominal=datAll.pla.hp.capHeaHp_nominal,
    QCoo_flow_nominal=datAll.pla.hp.capCooHp_nominal,
    mHw_flow_nominal=fourPipeASHP_with_controls_templatemodel.mHeaWatPri_flow_nominal,
    mChw_flow_nominal=fourPipeASHP_with_controls_templatemodel.mChiWatPri_flow_nominal,
...
equation
  ...
  connect(dpChiWatRem[1].port_a, senTemCooSup.port_a) annotation (Line(points={{30,-166},
          {30,-160},{40,-160}},
        color={0,127,255}));
  connect(junHeaWatBypSup2.port_3, fourPipeASHP_with_controls_templatemodel.port_a2)
    annotation (Line(points={{-230,-580},{-230,-564},{-272,-564},{-272,-396},{-280,
          -396}}, color={255,170,170}));
  connect(junHeaWatBypSup1.port_1, fourPipeASHP_with_controls_templatemodel.port_b2)
    annotation (Line(points={{-238,-508},{-270,-508},{-270,-372},{-314,-372},{-314,
          -396},{-300,-396}}, color={107,21,22}));
  connect(junChiWatBypSup1.port_3, fourPipeASHP_with_controls_templatemodel.port_b1)
    annotation (Line(points={{-146,-168},{-172,-168},{-172,-384},{-280,-384}},
        color={0,127,255}));
  connect(junChiWatBypRet1.port_3, fourPipeASHP_with_controls_templatemodel.port_a1)
  ...
  connect(busPumSecHeaWat, pumHeaWatSec.bus) annotation (Line(
      ...
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(ctl.yMod[3], fourPipeASHP_with_controls_templatemodel.uPlaOpeMod)
    annotation (Line(points={{-345.714,29.1628},{-304,29.1628},{-304,-386},{
          -302,-386}}, color={255,127,0}));
  connect(fourPipeASHP_with_controls_templatemodel.yPumEvaEnaPro, ctl.u1PumChiWatPri_actual[
    3]) annotation (Line(points={{-278,-390},{-258,-390},{-258,72},{-380,72},{
          -380,25.4233},{-377.143,25.4233}}, color={255,0,255}));
  connect(fourPipeASHP_with_controls_templatemodel.yHPEnaPro, ctl.u1Hp_actual[3])
    annotation (Line(points={{-278,-394},{-272,-394},{-272,36},{-304,36},{-304,
          44},{-320,44},{-320,108},{-396,108},{-396,29.3302},{-377.143,29.3302}},
        color={255,0,255}));
  connect(fourPipeASHP_with_controls_templatemodel.yPumConEnaPro, ctl.u1PumHeaWatPri_actual[
    3]) annotation (Line(points={{-278,-386},{-264,-386},{-264,52},{-316,52},{
          -316,112},{-400,112},{-400,48},{-392,48},{-392,27.0977},{-377.143,
          27.0977}}, color={255,0,255}));
  ...
  connect(weaBus, hp.busWea) annotation (Line(
      ...
      extent={{-3,6},{-3,6}},
      horizontalAlignment=TextAlignment.Right));
  connect(weaBus, fourPipeASHP_with_controls_templatemodel.weaBus) annotation (
      Line(
      points={{-401,175},{-556,175},{-556,32},{-564,32},{-564,-88},{-692,-88},{
  ...
  connect(ctl.THeaWatSupSet, fourPipeASHP_with_controls_templatemodel.THotWatSupSet)
    annotation (Line(points={{-345.714,-13.2558},{-302,-13.2558},{-302,-376}},
        color={0,0,127}));
  connect(ctl.TChiWatSupSet, fourPipeASHP_with_controls_templatemodel.TChiWatSupSet)
    annotation (Line(points={{-345.714,-14.9302},{-308,-14.9302},{-308,-380},{
          -302,-380}}, color={0,0,127}));
  connect(conPID1.y, fourPipeASHP_with_controls_templatemodel.uPumEvaSpe)
    annotation (Line(points={{-122,-90},{-230,-90},{-230,-408},{-310,-408},{-310,
          -406},{-302,-406}}, color={0,0,127}));
  ...
  connect(ctl.y1PumHeaWatSec, busPumSecHeaWat.y1) annotation (Line(points={{
      ...
      extent={{-3,6},{-3,6}},
      horizontalAlignment=TextAlignment.Right));
  connect(ctl.y1Hp[3], fourPipeASHP_with_controls_templatemodel.uHeaPumEna)
    annotation (Line(points={{-345.714,32.5116},{-318,32.5116},{-318,-390},{
          -302,-390}}, color={255,0,255}));
  ...
  connect(conPID.y, fourPipeASHP_with_controls_templatemodel.uPumConSpe)
    annotation (Line(points={{-122,-470},{-180,-470},{-180,-420},{-320,-420},{-320,
          -398},{-302,-398}}, color={0,0,127}));
  connect(ctl.y1PumChiWatPri[3], fourPipeASHP_with_controls_templatemodel.u1PumEvaEna)
    annotation (Line(points={{-345.714,16.8837},{-345.714,16},{-328,16},{-328,
          -402},{-302,-402}}, color={255,0,255}));
  connect(ctl.y1PumHeaWatPri[3], fourPipeASHP_with_controls_templatemodel.u1PumConEna)
