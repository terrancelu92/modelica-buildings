...
model HHW_CHW_plant_template_signal
...
public
  FourPipeASHP_with_controls_templatemodel_signalBus
    fourPipeASHP_with_controls_templatemodel_signalBus(
    m1_flow_nominal=fourPipeASHP_with_controls_templatemodel_signalBus.mChiWatPri_flow_nominal,
    m2_flow_nominal=fourPipeASHP_with_controls_templatemodel_signalBus.mHeaWatPri_flow_nominal,
    datAll=datAll,
    QHea_flow_nominal=datAll.pla.hp.capHeaHp_nominal,
    QCoo_flow_nominal=datAll.pla.hp.capCooHp_nominal,
    mHw_flow_nominal=fourPipeASHP_with_controls_templatemodel_signalBus.mHeaWatPri_flow_nominal,
    mChw_flow_nominal=fourPipeASHP_with_controls_templatemodel_signalBus.mChiWatPri_flow_nominal,
  ...
  Buildings.Templates.Components.Interfaces.Bus busHpSHC
    "SHC air-to-water heat pump control bus"
    annotation (Placement(transformation(extent={{-372,-410},{-332,-370}})));
equation
  if have_chiWat then
  end if;
  ...
  connect(valIso.port_bHeaWat, junHeaWatBypSup1.port_3) annotation (Line(points={{-678,
          -133},{-678,-560},{-228,-560},{-228,-518}},                 color={104,20,
          21}));
  ...
  connect(dpChiWatRem[1].port_a, senTemCooSup.port_a) annotation (Line(points={{30,-166},
          {30,-160},{40,-160}},
        color={0,127,255}));
  connect(junHeaWatBypSup2.port_3,
    fourPipeASHP_with_controls_templatemodel_signalBus.port_a2) annotation (
      Line(points={{-230,-580},{-230,-564},{-272,-564},{-272,-396},{-280,-396}},
        color={255,170,170}));
  connect(junHeaWatBypSup1.port_1,
    fourPipeASHP_with_controls_templatemodel_signalBus.port_b2) annotation (
      Line(points={{-238,-508},{-270,-508},{-270,-372},{-314,-372},{-314,-396},{
          -300,-396}}, color={107,21,22}));
  connect(junChiWatBypSup1.port_3,
    fourPipeASHP_with_controls_templatemodel_signalBus.port_b1) annotation (
      Line(points={{-146,-168},{-172,-168},{-172,-384},{-280,-384}}, color={0,127,
          255}));
  connect(junChiWatBypRet1.port_3,
    fourPipeASHP_with_controls_templatemodel_signalBus.port_a1) annotation (
      Line(points={{-146,-216},{-316,-216},{-316,-384},{-300,-384}}, color={0,127,
          255}));
  ...
  connect(weaBus, hp.busWea) annotation (Line(
      ...
      extent={{-3,6},{-3,6}},
      horizontalAlignment=TextAlignment.Right));
  connect(weaBus, fourPipeASHP_with_controls_templatemodel_signalBus.weaBus)
    annotation (Line(
      points={{-401,175},{-556,175},{-556,32},{-564,32},{-564,-88},{-692,-88},{-692,
          -112},{-696,-112},{-696,-176},{-620,-176},{-620,-248},{-508,-248},{-508,
          -212},{-336,-212},{-336,-392.5},{-299.5,-392.5}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
  ...
  connect(fourPipeASHP_with_controls_templatemodel_signalBus.busHpSHC, busHpSHC)
    annotation (Line(
      points={{-299.6,-389.4},{-352,-389.4},{-352,-390}},
      color={255,204,51},
      thickness=0.5));
connect(ctl.yMod[3], busHpSHC.uPlaOpeMod) annotation (Line(points={{-345.714,
          29.1628},{-314,29.1628},{-314,-418},{-352,-418},{-352,-390}},
                                                              color={244,125,35}),
                                                                                Text(string="%second", index=1, extent={{-6,3},{-6,3}}, horizontalAlignment=TextAlignment.Right));
connect(busHpSHC.yPumEvaEnaPro, ctl.u1PumChiWatPri_actual[3]) annotation (Line(points={{-352,
          -390},{-382,-390},{-382,-410},{-414,-410},{-414,-92},{-377.143,-92},{
          -377.143,25.4233}},                                                                                                                        color={255,0,
          255}),                                                                                                                                                       Text(string="%second", index=1, extent={{-6,3},{-6,3}}, horizontalAlignment=TextAlignment.Right));
connect(busHpSHC.yHPEnaPro, ctl.u1Hp_actual[3]) annotation (Line(points={{-352,
          -390},{-316,-390},{-316,-342},{-368,-342},{-368,-152},{-377.143,-152},
          {-377.143,29.3302}},                                                                                                         color={255,0,
          255}),                                                                                                                                         Text(string="%second", index=1, extent={{-6,3},{-6,3}}, horizontalAlignment=TextAlignment.Right));
connect(busHpSHC.yPumConEnaPro, ctl.u1PumHeaWatPri_actual[3]) annotation (Line(points={{-352,
          -390},{-386,-390},{-386,-406},{-404,-406},{-404,-234},{-377.143,-234},
          {-377.143,27.0977}},                                                                                                                       color={255,0,
          255}),                                                                                                                                                       Text(string="%second", index=1, extent={{-6,3},{-6,3}}, horizontalAlignment=TextAlignment.Right));
connect(ctl.THeaWatSupSet, busHpSHC.THwSet) annotation (Line(points={{-345.714,
          -13.2558},{-314,-13.2558},{-314,-418},{-352,-418},{-352,-390}},                                                                 color={0,0,127}), Text(string="%second", index=1, extent={{-6,3},{-6,3}}, horizontalAlignment=TextAlignment.Right));
connect(ctl.TChiWatSupSet, busHpSHC.TChwSet) annotation (Line(points={{-345.714,
          -14.9302},{-314,-14.9302},{-314,-418},{-352,-418},{-352,-390}},                                                                 color={0,0,127}), Text(string="%second", index=1, extent={{-6,3},{-6,3}}, horizontalAlignment=TextAlignment.Right));
connect(conPID1.y, busHpSHC.uPumEvaSpe) annotation (Line(points={{-122,-90},{-314,
          -90},{-314,-418},{-352,-418},{-352,-390}},                                                                           color={0,0,127}), Text(string="%second", index=1, extent={{-6,3},{-6,3}}, horizontalAlignment=TextAlignment.Right));
connect(ctl.y1Hp[3], busHpSHC.y1) annotation (Line(points={{-345.714,32.5116},{
          -314,32.5116},{-314,-418},{-352,-418},{-352,-390}},                                                                    color={255,0,
          255}),                                                                                                                                   Text(string="%second", index=1, extent={{-6,3},{-6,3}}, horizontalAlignment=TextAlignment.Right));
connect(conPID.y, busHpSHC.uPumConSpe) annotation (Line(points={{-122,-470},{-318,
          -470},{-318,-424},{-352,-424},{-352,-390}},                                                                         color={0,0,127}), Text(string="%second", index=1, extent={{-6,3},{-6,3}}, horizontalAlignment=TextAlignment.Right));
connect(ctl.y1PumChiWatPri[3], busHpSHC.u1PumEvaEna) annotation (Line(points={{
          -345.714,16.8837},{-320,16.8837},{-320,-408},{-352,-408},{-352,-390}},                                                            color={255,0,
          255}),                                                                                                                                              Text(string="%second", index=1, extent={{-6,3},{-6,3}}, horizontalAlignment=TextAlignment.Right));
connect(ctl.y1PumHeaWatPri[3], busHpSHC.u1PumConEna) annotation (Line(points={{
          -345.714,18.5581},{-316,18.5581},{-316,-412},{-352,-412},{-352,-390}},                                                            color={255,0,
          255}),                                                                                                                                              Text(string="%second", index=1, extent={{-6,3},{-6,3}}, horizontalAlignment=TextAlignment.Right));
  annotation (
    __Dymola_Commands(
      file=
...
end HHW_CHW_plant_template_signal;
